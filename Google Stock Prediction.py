...
get_data('C:\\Users\\Wes\\PycharmProjects\\untitled1\\google.csv')  # calling get_data method by passing the csv file to it
print (dates)
print (prices)
print ("\n")
...
print ("The stock open price for next date is: $", str(predicted_price))
